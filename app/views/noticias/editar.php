...
<head>
    ...
    <title>Editar Noticia - Pato's Sport</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><i class="fas fa-edit text-warning"></i> Editar Noticia</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?php echo URL; ?>index.php">Inicio</a></li>
                                <li class="breadcrumb-item"><a href="<?php echo URL; ?>index.php?c=Noticia&a=index">Noticias</a></li>
                                ...
                                <form method="POST" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="descripcion" name="descripcion" maxlength="500" value="<?php echo htmlspecialchars($noticia['descripcion'] ?? ''); ?>" placeholder="Breve descripción que aparecerá en el listado">
                                        </div>

                                        <div class="form-group">
                                            <label for="contenido">Contenido <span class="text-danger">*</span></label>
                                            <textarea class="form-control" id="contenido" name="contenido" rows="8" required><?php echo htmlspecialchars($noticia['contenido']); ?></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="imagen">Imagen</label>
                                            
                                            <?php if(!empty($noticia['imagen']) && file_exists('public/img/' . $noticia['imagen'])): ?>
                                                <div class="mb-3 p-3 bg-light rounded">
                                                    ...
                                                    <img src="<?php echo URL; ?>public/img/<?php echo htmlspecialchars($noticia['imagen']); ?>" 
                                                         ...
                                                         style="max-height: 150px; max-width: 200px; border-radius: 4px;">
                                                </div>
                                            <?php else: ?>
                                                <p class="text-muted">Sin imagen adjunta</p>
                                            <?php endif; ?>
                                            
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="imagen" name="imagen" accept=".jpg,.jpeg,.png,.gif">
                                                <label class="custom-file-label" for="imagen">Selecciona una imagen (JPG, PNG, GIF)</label>
                                            </div>
                                            <small class="form-text text-muted">Deja en blanco si no deseas cambiar la imagen. Máximo 5MB.</small>
                                        </div>

                                        <div class="form-group">
                                            <label for="estado">Estado</label>
                                            <select class="form-control" id="estado" name="estado">
                                                <option value="activa" <?php echo $noticia['estado'] === 'activa' ? 'selected' : ''; ?>>Activa</option>
                                                <option value="inactiva" <?php echo $noticia['estado'] === 'inactiva' ? 'selected' : ''; ?>>Inactiva</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                        <a href="<?php echo URL; ?>index.php?c=Noticia&a=index" class="btn btn-secondary">
