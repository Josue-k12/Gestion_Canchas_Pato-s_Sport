...
<head>
    ...
    <style>
        ...
        @media (max-width: 767px) {
            #tablaAlquileres thead { display: none; }
            #tablaAlquileres tbody tr {
                display: block;
                margin-bottom: 1rem;
            ...
            #tablaAlquileres tbody td:last-child { border-bottom: none; }
            #tablaAlquileres tbody td::before {
            ...
            #tablaAlquileres .btn-group-vertical { flex-direction: row; flex-wrap: wrap; justify-content: flex-end; }
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="<?php echo URL; ?>index.php?c=Alquiler&a=crear" class="btn btn-primary btn-sm">
                                ...
                                <table id="tablaAlquileres" class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        <?php if(!empty($alquileres)): ?>
                                            ...
                                            <tr>
                                                <td data-label="ID"><?php echo $alquiler['alquiler_id']; ?></td>
                                                ...
                                                <td data-label="Hora Final"><?php echo date('H:i', strtotime($alquiler['alquiler_hora_final'])); ?></td>
                                                <td data-label="Valor">
                                                ...
                                                <td data-label="Comprobante" class="text-center">
