                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="actions-bar">
                                <a href="<?php echo URL; ?>index.php?c=Alquiler&a=crear" class="btn btn-primary btn-nueva-reserva">
                                    <i class="fas fa-plus"></i> Nueva Reserva
                                </a>
                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalImportante">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php else: ?>
                                        <table id="tablaAlquileres" class="table table-bordered table-striped table-responsive-card">
                                            <thead>
                                                <tr>
                                                    <th>Cancha</th>
                                                    <th>Fecha</th>
                                            ...
                                            <tbody>
                                                <?php foreach ($alquileres as $alquiler): ?>
                                                    <tr>
                                                        ...
                                                        <td data-label="Hora Inicial"><?php echo $alquiler['alquiler_hora_inicial']; ?></td>
                                                        <td data-label="Hora Final"><?php echo $alquiler['alquiler_hora_final']; ?></td>
                                                        <td data-label="Valor">$<?php echo number_format($alquiler['alquiler_valor'], 0, ',', '.'); ?></td>
