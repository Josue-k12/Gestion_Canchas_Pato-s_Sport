...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card card-primary">
                                ...
                                <form action="<?php echo URL; ?>index.php?c=Alquiler&a=editar&id=<?php echo $alquiler['id']; ?>" method="POST" enctype="multipart/form-data" id="formAlquiler">
                                    <div class="card-body">
                                        ...
                                        <!-- Comprobante de Pago -->
                                        <div class="form-group">
                                            <label for="alquiler_comprobante_pago">Comprobante de Pago</label>
                                            ...
                                            <?php else: ?>
                                                <p class="text-muted">Sin comprobante adjunto</p>
                                            <?php endif; ?>
                            ...
                            <div class="card card-outline card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>
                                        ...
                                        $<?php echo number_format($alquiler['alquiler_valor'] / max(1, $alquiler['alquiler_valor']), 0, ',', '.'); ?>
                                    </p>
                                    <hr>
    ...
    <script>
        const precioHora = <?php echo ($alquiler['alquiler_valor'] > 0) ? ($alquiler['alquiler_valor']) : 20; ?>;
