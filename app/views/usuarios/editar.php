...
<head>
    ...
    <title>Editar Usuario - Pato's Sport</title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo URL; ?>index.php?c=Usuario&a=index">Usuarios</a></li>
                            ...
                            <div class="card card-primary">
                                ...
                                <form method="POST" class="form-horizontal">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="password">Nueva Contraseña <span class="text-muted">(Dejar vacío para no cambiar)</span></label>
                                        ...
                                        <div class="alert alert-info">
                                            <i class="fas fa-info-circle"></i> Miembro desde: <?php echo date('d/m/Y', strtotime($usuario['creado_en'])); ?>
                                        </div>
                                    </div>

                                    <div class="card-footer">
                                        <a href="<?php echo URL; ?>index.php?c=Usuario&a=index" class="btn btn-secondary">
