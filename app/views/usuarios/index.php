...
<head>
    ...
    <title>Usuarios - Pato's Sport</title>
    ...
    <style>
        ...
        .badge-encargado { background-color: #ffc107; color: #000; }
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="<?php echo URL; ?>index.php?c=Usuario&a=crear" class="btn btn-primary btn-sm">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-<?php 
                                                            $rolName = strtolower($usuario['rol_nombre']);
                                                            echo str_replace(' ', '-', $rolName);
                                                        ?>">
                                                    ...
                                                    <td>
                                                        <a href="<?php echo URL; ?>index.php?c=Usuario&a=editar&id=<?php echo $usuario['id']; ?>" class="btn btn-warning btn-sm">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <?php if ($usuario['id'] != $_SESSION['user_id']): ?>
                                                            <a href="<?php echo URL; ?>index.php?c=Usuario&a=eliminar&id=<?php echo $usuario['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de eliminar este usuario?')">
