...
<head>
    ...
    <title>Editar Hora - Pato's Sport</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><i class="fas fa-edit text-success"></i> Editar Hora</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?php echo URL; ?>index.php">Inicio</a></li>
                                <li class="breadcrumb-item"><a href="<?php echo URL; ?>index.php?c=Hora&a=index">Horas</a></li>
                                ...
                                <form method="POST" class="form-horizontal">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control" id="hora" name="hora" value="<?php echo substr($hora['hora'], 0, 5); ?>" required>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                        <a href="<?php echo URL; ?>index.php?c=Hora&a=index" class="btn btn-secondary">
