...
<head>
    ...
    <title>Horas - Pato's Sport</title>
    ...
    <style>
        ...
        .badge-success { background-color: var(--verde-patos); }
    </style>
</head>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><i class="fas fa-clock text-success"></i> Gestión de Horas</h1>
                        </div>
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-list"></i> Lista de Horas Disponibles</h3>
                            <div class="card-tools">
                                <a href="<?php echo URL; ?>index.php?c=Hora&a=crear" class="btn btn-primary btn-sm">
                                    <i class="fas fa-plus-circle"></i> Nueva Hora
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    <?php if (!empty($horas)): ?>
                                        <?php foreach ($horas as $hora): ?>
                                            <tr>
                                                <td><?php echo $hora['id_hora']; ?></td>
                                                <td><span class="badge badge-success"><?php echo substr($hora['hora'], 0, 5); ?></span></td>
                                                <td>
                                                    <a href="<?php echo URL; ?>index.php?c=Hora&a=editar&id=<?php echo $hora['id_hora']; ?>" class="btn btn-warning btn-sm">
                                                        <i class="fas fa-edit"></i> Editar
                                                    </a>
                                                    <a href="<?php echo URL; ?>index.php?c=Hora&a=eliminar&id=<?php echo $hora['id_hora']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro?')">
                                        ...
                                        <?php endforeach; ?>
                                    <?php else: ?>
                                        <tr><td colspan="3" class="text-center text-muted">No hay horas registradas</td></tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                        </div>
